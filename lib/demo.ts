...
export const demoShowcase = [
  {
    ...
    featuredImage: { node: { sourceUrl: "/images/solutions/pallet-shuttles/shuttle-in-operation.avif", altText: "Dense storage solution" } },
  ...
  },
  {
    ...
    featuredImage: { node: { sourceUrl: "/images/solutions/amr/t-sort.jpg", altText: "AMR sortation system" } },
  ...
  },
  {
    ...
    featuredImage: { node: { sourceUrl: "/images/solutions/vlm/climate-control.png", altText: "Cold storage facility" } },
