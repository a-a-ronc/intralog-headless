...
export default async function PartnersPage() {
  ...
  // shared inline styles so we don't touch global CSS
  const cardStyle: React.CSSProperties = {
    textAlign: 'center',
    display: 'grid',
    gridTemplateRows: '1fr auto',   // logo area fills, optional title on bottom
    minHeight: '140px',
    padding: '16px'
  }
  ...
  return (
    <main className="section">
      <div className="container">
        <strong>Partners & Collaborators</strong>
        ...
        <div className="grid" style={{ marginTop: '1rem' }}>
          ...
          <div className="card" style={cardStyle}>
            <div style={logoWrapStyle}>
              <img
                alt="Interlake Mecalux, Warehouse solutions"
                title="Interlake Mecalux, Warehouse solutions"
          ...
          <div className="card" style={cardStyle}>
            <div style={logoWrapStyle}>
              <svg
                ...
                viewBox="0 0 88.88 61.03"
                aria-label="Modula logo"
                role="img"
                className="partner-logo"
                style={imgFillStyle}
              >
          ...
          <div className="card" style={cardStyle}>
            <div style={logoWrapStyle}>
              <img
                src="https://ryson.com/wp-content/uploads/2023/05/ryson-logo_sm.png"
                alt="Ryson"
                className="partner-logo"
                style={imgFillStyle}
              />
          ...
          <div className="card" style={cardStyle}>
            <div style={logoWrapStyle}>
              <img
                src="https://fmhconveyors.com/wp-content/uploads/2021/03/fmh-logo.svg"
                alt="FMH Conveyors"
                className="partner-logo"
                style={imgFillStyle}
              />
          ...
          <div className="card" style={cardStyle}>
            <div style={logoWrapStyle}>
              <img
                src="https://www.mccue.com/hubfs/images/assets/logos/mccue-logo-on-dark.svg"
                alt="McCue"
                className="partner-logo"
                style={imgFillStyle}
              />
          ...
          <div className="card" style={cardStyle}>
            <div style={logoWrapStyle}>
              <img
                src="https://www.handleitinc.com/wp-content/uploads/2025/05/HII-Horizontal-Logo-center-justified-2024-scaled-e1748528058528.png"
                alt="Handle It Inc"
                className="partner-logo"
                style={imgFillStyle}
              />
