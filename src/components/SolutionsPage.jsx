        ...
        <div className="mx-auto max-w-7xl px-6 py-14 lg:py-16">
          ...
          <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
            {PARTNER_LOGOS.map((logo) => (
              <div key={logo.name} className="flex items-center justify-center rounded-xl border border-slate-200 bg-white p-4 group">
                <img
                  src={logo.src}
                  alt={`${logo.name} logo`}
                  className="h-8 w-auto opacity-80 transition-all duration-300 ease-out filter grayscale group-hover:opacity-100 group-hover:filter-none group-hover:scale-105"
                />
              </div>
            ))}
          </div>
      ...
      <section className="border-t border-slate-100 bg-slate-900 text-white">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-6 inline-flex items-center rounded-full bg-white px-5 py-3 text-slate-900 shadow-sm cursor-pointer hover:bg-gray-100 transition-colors">
