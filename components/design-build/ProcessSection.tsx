  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-12">
      <header className="mb-10">
        <p className="text-sm uppercase tracking-wider text-[rgb(var(--muted-fg))]">Design–Build</p>
        <h2 className="mt-2 text-4xl font-semibold tracking-tight text-[rgb(var(--fg))]">Our Process</h2>
          ...
          <Card key={number}>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[rgb(var(--muted-fg))]">{description}</p>
              </div>
            </div>
            <div className="mt-4 text-[rgb(var(--fg))]">
              <Graphic />
            </div>
          </Card>
        ))}
      ...
      <div className="mt-12">
        <Card>
          <h3 className="text-lg font-semibold text-[rgb(var(--fg))]">Tools we use along the way</h3>
          <ul className="mt-3 grid gap-3 sm:grid-cols-2">
            <li className="text-[rgb(var(--muted-fg))]">
              <span className="font-medium text-[rgb(var(--fg))]">Footprint Model:</span> determine exact facility size for current + projected volume.
            </li>
            <li className="text-[rgb(var(--muted-fg))]">
              <span className="font-medium text-[rgb(var(--fg))]">Warehousr:</span> bin right-sizing, shelf design, seasonal re-slotting.
            </li>
            <li className="text-[rgb(var(--muted-fg))]">
              <span className="font-medium text-[rgb(var(--fg))]">DensityPro:</span> headless sequencer that guides optimal pick paths for +15–25% throughput.
            </li>
            <li className="text-[rgb(var(--muted-fg))]">
              <span className="font-medium text-[rgb(var(--fg))]">Painless Permit:</span> automated submittals and reviewer responses for NFPA/FM/IBC/OSHA.
            </li>
            <li className="text-[rgb(var(--muted-fg))]">
              <span className="font-medium text-[rgb(var(--fg))]">Python & R analytics:</span> demand modeling, SKU clustering, labor forecasting, ROI.
            </li>
            <li className="text-[rgb(var(--muted-fg))]">
              <span className="font-medium text-[rgb(var(--fg))]">Vendor network:</span> competitive RFQs across conveyors, storage, robotics, and integration.
            </li>
          </ul>
        </Card>
      </div>
